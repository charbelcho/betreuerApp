...
<head>
    ...
    <title>Zweitgutachter</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <a class="navbar-brand" href="Tutor.html">Zweitgutachter</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#">Zweitgutachter</a>
            </li>
            <li class="nav-item">
    ...
    <br>
<div class="container">
    <?php /* zeigt alle Zweitgutachter in einer Tabelle */ require_once ("betreuerDb.php") ?>
</div>
